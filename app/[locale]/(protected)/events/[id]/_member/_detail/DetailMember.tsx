...
import { useEventMemberDetail } from "./useDetailMember";
...
export const EventMemberDetail = React.memo(({ eventId, cardId, isOpen, onClose }: Props) => {
  ...
  const {
    ...
    onHoverInfo,
    onHoverOutInfo,
  } = useEventMemberDetail({ eventId, cardId });
